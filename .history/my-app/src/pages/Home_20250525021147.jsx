...
export default function Home(params) {
    return (
        <div>
            <div className="w-screen h-auto absolute top-0 left-0 z-0 overflow-hidden">
                <div className="w-full overflow-hidden h-full bg-black absolute opacity-55">

                </div>
                <div>
                    <img src={bg} className="w-full overflow-hidden"></img>
                </div>
            </div>
