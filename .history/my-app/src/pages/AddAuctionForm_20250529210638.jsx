...
export default function AddAuctionForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${API}/addauction/add`, form);
            ...
            <div className='w-4/6 h-full px-10 pt-10 '>
                    ...
                    <div className='w-1/2 space-y-5'>
                        ...
                        <div className='bg-zinc-800 rounded-xl p-5'>
                            ...
                            <div className='w-full flex'>
                                ...
                                <div className='w-1/3 flex justify-center items-center'>base_price</div>
                                <div className='w-1/3 flex justify-center items-center'>min_player</div>
                            ...
                            {form.tiers.map((tier) => (
                                <div key={tier} className='flex items-center mb-2'>
                                    ...
                                    <input
                                        ...
                                        className='w-1/3 h-8 bg-zinc-700 mx-2 rounded-xl px-3 text-white'
                                        />
                                    <input
                                        type="number"
                            ...
                            <div className='flex mt-4 gap-2 h-12 items-start'>
                                <div className='w-2/3 flex  h-full items-center justify-center'>
                                    <input
                                        type="text"
                ...
                <div className='mt-6'>
                    <button
                        ...
                        className='text-white font-semibold px-6 py-2 rounded hover:text-black font-rubik hover:bg-white mb-10'
                    >
                        Submit Auction
                    </button>
                </div>
