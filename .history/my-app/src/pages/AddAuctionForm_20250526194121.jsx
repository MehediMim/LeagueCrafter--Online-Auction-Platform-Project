...
export default function AddAuctionForm() {
    ...
    return (
        <div className='w-screen h-screen flex bg-black text-white font-raleway'>
            <div className='w-1/6 h-full bg-zinc-900'></div>

            <div className='w-5/6 h-full px-10 pt-10 overflow-y-auto'>
                <div className='h-1/6 text-4xl font-bold mb-6 font-rubik'>Create New Auction</div>
                ...
                <div className='mt-6'>
                    <button
                        ...
                        className='bg-yellow-400 text-black font-bold px-6 py-2 rounded hover:bg-yellow-300'
                    >
                        Submit Auction
                    </button>
                </div>
