                    ...
                    {players.map((player) => (
                        ...
                        >
                            ...
                            <div className=' z-10  h-auto  bg-gray-900 bg-opacity-70  rounded-b-xl rounded-xl overflow-hidden'>
                                ...
                                <div className='w-full  flex h-auto justify-start items-center   px-2 pt-2 bg-gray-700'><div className='text-xl font-raleway w-full flex justify-center items-center'>{player.role}</div></div>
