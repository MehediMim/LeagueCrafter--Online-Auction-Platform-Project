                    ...
                    {budgets.map(team => (
                        ...
                        >
                            <div className="flex justify-between items-center text-black">
                                <div>
                                    <div>{team.name}</div>
                                    <div className="text-sm text-gray-300">Safe Max Bid: ${safeBids[team._id] ?? '...'}</div>
                                </div>
...
function TeamModal({ team, auctionId, onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50">
            <div className="bg-white text-black p-6 rounded-xl w-full max-w-2xl relative max-h-[90vh] overflow-y-auto">
                <button
                    onClick={onClose}
                ...
                {players.length === 0 ? (
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {players.map(player => (
                            <div
                                key={player._id}
                                className="bg-gray-100 rounded-lg p-3 shadow-md flex items-center"
                            >
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-sm text-gray-700">{player.role}</p>
                                    <p className="text-sm text-gray-500">{player.category?.name || "Unknown Tier"} – ${player.price}</p>
                                </div>
                            </div>
                        ))}
                    </div>
