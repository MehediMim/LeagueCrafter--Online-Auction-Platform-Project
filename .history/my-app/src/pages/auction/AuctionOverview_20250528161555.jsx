            ...
            <div className='w-3/4  flex '>
                <div className='w-1/2 h-full '>
                    ...
                    <div className='bg-zinc-800 rounded-xl m-3 p-3 pl-10'>
                        ...
                        <div className='font-raleway font-bold text-2xl'>{auction?.date ? new Date(auction.date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })  : "date"}</div>
                    </div>
