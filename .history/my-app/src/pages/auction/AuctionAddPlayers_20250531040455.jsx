            ...
            <div className=' font-kanit '>
                ...
                <div className="grid grid-cols-4 gap-6 space-x-4 ">
                    {players.map(player => (
                        <div
                            key={player._id}
                            className="w-56 h-96 p-4 rounded bg-zinc-800 text-white shadow-md flex flex-col justify-between items-center"
                        >

                            <div className='w-full h-full p-2'>
                                <div className='w-full h-10 bg-slate-50'></div>
                                <div className='w-full h-1/2 bg-slate-400'></div>
                                <div className='w-full flex-wrap h-1/2 bg-slate-600'></div>
                            </div>
