                            ...
                            <div className=' z-10  h-auto  bg-gray-900 bg-opacity-70  rounded-b-xl rounded-xl overflow-hidden'>
                                ...
                                <div className='bg-gray-900 w-full px-2  flex justify-center items-center'>
                                    <button
                                        ...
                                        className="hidden group-hover:block  p-2 font-rubik font-bold hover:bg-white hover:text-black text-white text-sm px-4  rounded  hover:text-black transition"
                                    >
                                        Delete
                                    </button>
                                </div>
