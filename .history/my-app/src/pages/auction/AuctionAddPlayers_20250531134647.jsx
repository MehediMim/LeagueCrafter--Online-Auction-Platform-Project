            ...
            <div className="max-w-7xl mx-auto font-raleway">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {players.map((player) => (
                        <div
                            key={player._id}
                            className="bg-gray-800 p-2 h-72 w-52 rounded-xl shadow-md flex flex-col justify-end"
                            style={{
                                backgroundColor: player.category?.color || '#27272a',
                            }}
                        >
                            <div className="w-full h-1/2 flex items-center justify-center rounded-t-xl overflow-hidden bg-gray-700">
                                <img
                                    src={player.photo_url || '/default_avatar.png'} // Use your default image path
                                    alt={player.name}
                            ...
                            <div className='h-1/2 w-full bg-gray-900 bg-opacity-70 p-2 rounded-b-xl rounded-xl'>
                                ...
                                <p className='text-sm'>Tier: {player.category?.name || 'Uncategorized'}</p>
                                <button
