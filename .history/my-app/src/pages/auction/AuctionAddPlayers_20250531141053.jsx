                        ...
                        >
                            ...
                            <div className=' z-10  h-auto  bg-gray-900 bg-opacity-70  rounded-b-xl rounded-xl'>
                                ...
                                <div className='h-32 bg-white'>
                                    <p className='font-bebas relative h-auto bottom-0 text-3xl flex px-2 bg-gray-900  rounded-t-xl bg-opacity-50 items-center'>{calculateAge(player.dob)}<div className='text-lg ml-1'> years</div></p>
                                </div>
                                <div className='w-full relative flex h-auto justify-start items-center rounded-t-xl px-2 pt-2 bg-gray-900'><p className='text-xl font-raleway'>{player.role}</p></div>
