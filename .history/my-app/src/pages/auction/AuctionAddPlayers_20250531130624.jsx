                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {players.map((player) => (
                        <div key={player.id} className="bg-gray-800  p-2  h-72 w-52 rounded-xl shadow-md">
                            ...
                            <div className='w-full flex justify-start items-end h-full bg-white'>
                                <div className='h-1/2 w-full '>
                                    <div>
                                        <h2 className="text-2xl bg-gray-800 bg-opacity-80 font-semibold font-bebas">{player.name}</h2>
