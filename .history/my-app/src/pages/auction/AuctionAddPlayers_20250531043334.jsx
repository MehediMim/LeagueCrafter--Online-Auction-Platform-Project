...
export default function AuctionAddPlayers() {
    ...
    return (
        <div className='min-h-screen w-full px-10 py-10 flex flex-col '>
            <div className='w-full font-kanit'>
                ...
                <div className="grid grid-cols-4 gap-6">
                    {players.map(player => (
                        <div
                            key={player._id}
                            className="w-56 h-96 p-3 relative rounded bg-zinc-800 border border-gray-700 text-white shadow-lg flex flex-col justify-between"
                        >
                            <div>
                                <h2 className='font-bebas text-3xl text-center w-full justify-start items-start flex'>{player.name}</h2>
