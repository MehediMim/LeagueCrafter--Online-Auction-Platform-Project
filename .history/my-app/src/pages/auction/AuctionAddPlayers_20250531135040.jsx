            ...
            <div className="max-w-7xl mx-auto font-raleway">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {players.map((player) => (
                        ...
                        >
                            <div className="w-52 bg-black h-72 p-2 relative flex items-center justify-center rounded-t-xl overflow-hidden bg-gray-700">
                                <img
                            ...
                            <div className='relative h-1/2 w-full bg-gray-900 bg-opacity-70 p-2 rounded-b-xl rounded-xl'>
