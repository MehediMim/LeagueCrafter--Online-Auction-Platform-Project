                    ...
                    {players.map((player) => (
                        ...
                        >
                            ...
                            <div className=' z-10  h-auto  bg-gray-900 bg-opacity-70  rounded-b-xl rounded-xl'>
                                ...
                                <div className='w-full  flex h-auto justify-start items-center w-full rounded-b-xl px-2 pt-2 bg-gray-900'><p className='text-xl font-raleway bg-slate-700'>{player.role}</p></div>
