...
export default function AuctionAddPlayers() {
    ...
    return (
        <div className='ml-20 mt-20 flex flex-col justify-center items-start h-full w-full'>
            <div className='w-11/12 font-kanit'>
                {/* <h1 className="text-4xl font-rubik font-bold text-white mb-10">All Players</h1> */}
                    <div>
                        <h1 className="text-4xl font-rubik font-bold text-white mt-40">All Players</h1>
                    </div>
                <div className="grid grid-cols-4 gap-6 mt-96">
                    {players.map(player => (
                        <div
                            key={player._id}
                        ...
                        >
                            <div>
                                {/* Player Name */}
                                <h2 className='font-bebas text-3xl text-center'>{player.name}</h2>
                                ...
                                {/* Age */}
                                <div className='font-raleway text-md text-center'>
