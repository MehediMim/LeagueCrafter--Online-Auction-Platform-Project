...
export default function AuctionAddPlayers() {
    ...
    return (
        <div className='min-h-screen w-full max-w-screen overflow-x-hidden px-6 py-10 flex flex-col bg-zinc-900'>
            <div className='w-full font-kanit'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {players.map(player => (
                        <div
                            key={player._id}
                            className="w-full h-96 p-3 rounded bg-zinc-800 border border-gray-700 text-white shadow-lg flex flex-col justify-between"
                        >
                            <div>
