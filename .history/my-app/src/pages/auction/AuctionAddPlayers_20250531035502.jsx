...
export default function AuctionAddPlayers() {
    ...
    return (
        <div className='flex bg-slate-500 justify-center items-center h-full w-full'>
            <div className='w-5/6 font-kanit bg-slate-400'>
                <h1 className="text-4xl font-rubik font-bold text-white mb-6">All Players</h1>

                <div className="grid grid-cols-4 gap-6 space-x-4 bg-slate-50">
                    {players.map(player => (
                        <div
                            key={player._id}
                            className="w-56 h-80 p-4 rounded bg-zinc-800 text-white shadow-md flex flex-col justify-between"
                        >
                            <div>
