                    ...
                    {players.map(player => (
                        ...
                        >
                            <div>
                                ...
                                <div className='text-center mb-2 relative -top-16 w-full flex  justify-evenly bg-white'>
                                    <span className='text-sm font-semibold bg-slate-800 px-3 py-1 rounded-full border border-black'>
                                        {player.role}
                                    </span>
                                    <span className='text-sm font-semibold bg-slate-800 px-3 py-1 rounded-full font-jaro text-5xl border border-black'>
