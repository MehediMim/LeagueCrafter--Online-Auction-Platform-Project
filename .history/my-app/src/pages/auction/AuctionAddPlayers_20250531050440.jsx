                    ...
                    {players.map(player => (
                        ...
                        >
                            <div>
                                ...
                                <div className='text-center mb-2 relative -top-28 right-10 w-full flex  justify-evenly '>

                                    <span className=' font-semibold bg-slate-800 px-3 py-1 rounded-full font-raleway text-5xl border border-black'>
