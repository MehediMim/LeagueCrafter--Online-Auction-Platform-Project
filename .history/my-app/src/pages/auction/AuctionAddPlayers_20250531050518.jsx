                    ...
                    {players.map(player => (
                        ...
                        >
                            <div>
                                ...
                                <div className='text-center mb-2 relative -top-16 w-full flex  justify-evenly '>
                                    <span className='text-sm font-semibold bg-slate-800 px-3 right-10 py-1 rounded-full border border-black'>
                                        {player.role}
                                    </span>

                                </div>
                                <div className='text-center mb-2 relative -top-28 -right-20 w-full flex  justify-evenly '>
