    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50">
            <div className="bg-white text-black p-6 rounded-xl w-full max-w-md relative">
                ...
                <p><strong>Color Code:</strong> <span className="px-2 py-1 rounded" style={{ backgroundColor: team.color_code }}>{team.color_code}</span></p>
                <p><strong>Remaining Budget:</strong> ${team.remaining}</p>
                <p><strong>Tier Summary:</strong></p>
