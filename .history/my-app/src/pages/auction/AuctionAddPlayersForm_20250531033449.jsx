        ...
        <div className='w-full h-full p-10 text-white font-raleway flex pt-40'>
            ...
            <div className='w-3/6'>
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    {/* Role */}
                    <div className='bg-zinc-800 p-5 rounded-xl flex'>
                        <label className='w-1/3 font-bold text-xl pl-5'>Player Role</label>
                        <input
                            type='text'
                            name='role'
                            value={form.role}
                            onChange={handleChange}
                            placeholder='e.g. Goalkeeper, Opening Batsman'
                            className='w-2/3 h-10 bg-zinc-700 rounded-xl px-3 text-white'
                        />
                    </div>
                    ...
                    {/* DOB */}
                    <div className='bg-zinc-800 p-5 rounded-xl flex'>
                        <label className='w-1/3 font-bold text-xl pl-5'>Date of Birth</label>
                        <input
                            type='date'
                            name='dob'
                            value={form.dob}
