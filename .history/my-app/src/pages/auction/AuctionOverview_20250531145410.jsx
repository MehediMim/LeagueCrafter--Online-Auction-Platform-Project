                    ...
                    <div className='bg-zinc-800 rounded-xl m-3 p-3 pl-10'>
                        ...
                        {categories.length === 0 ? (
                            ...
                            categories.map((cat) => (
                                <div
                                    key={cat._id}
                                    className='flex justify-between font-raleway items-center p-2 rounded-lg my-1'
                                    style={{ backgroundColor: cat.color || "#ffffff" }}
                                >
                                    <div className='font-semibold text-black w-1/3'>{cat.name}</div>
                                    <div className='text-black w-1/3'>💰 {cat.base_price}</div>
                                    <div className='text-black w-1/3'>👥 Min: {cat.min_players}</div>
                                </div>
                            ))
                        )}
                    </div>
