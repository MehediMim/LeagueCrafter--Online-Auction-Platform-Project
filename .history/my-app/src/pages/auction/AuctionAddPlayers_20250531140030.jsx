                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {players.map((player) => (
                        ...
                        >
                            ...
                            <div className=' z-10 m-2 h-36  bg-gray-900 bg-opacity-70 p-2 rounded-b-xl rounded-xl'>
                                ...
                                <button
                                    ...
                                    className="hidden group-hover:block relative top-10 mt-2 bg-red-600 text-white text-sm px-4 py-1 rounded hover:bg-red-700 transition"
                                >
                                    Delete
                                </button>
                            </div>
