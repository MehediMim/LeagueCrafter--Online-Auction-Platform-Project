...
export default function AuctionAddPlayers() {
    ...
    const assignTeamToPlayer = async () => {
        ...
        try {
            await axios.put(`${API}/player/update/${selectedPlayer._id}`, {
            ...
            window.alert("❌ Failed to assign team.");
        }
    };
                                    ...
                                    >
                                        <div className="w-52 h-72  absolute flex items-center justify-center rounded-xl overflow-hidden">
                                            <img
                                                ...
                                                alt={player.name}
                                                className="z-10 p-2 rounded-2xl object-cover w-52 h-72"
                                                onError={(e) => {
                                        ...
                                        <div className="z-10 h-auto bg-gray-900 bg-opacity-70 rounded-b-xl rounded-xl overflow-hidden">
                                            ...
                                            <p className="font-bebas relative text-gray-400 mr-2 h-auto text-3xl flex p-2 bg-gray-900 justify-center bg-opacity-50 items-center">
                                                {calculateAge(player.dob)}
                                                {/* <span className="text-lg ml-1 font-raleway">years old</span> */}
                                                <div className='border-l-2 border-gray-400 text-gray-200 font-raleway text-lg ml-1 pl-1'>
                                                    {player.category?.name}
                                                </div>
                                            </p>
