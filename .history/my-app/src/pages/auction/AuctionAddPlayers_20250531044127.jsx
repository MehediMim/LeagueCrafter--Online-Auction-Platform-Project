            ...
            <div className='w-full font-kanit'>
                ...
                <div className="grid grid-cols-4 gap-6">
                    {players.map(player => (
                        ...
                        >
                            <div>
                                <div className='font-bebas absolute bg-zinc-800 rounded-br-full pr-5 w-auto text-3xl text-center '>
                                    <div className=' justify-start items-start flex'>{player.name}</div>
                                    <div className=' justify-start items-end flex bg-white'>{calculateAge(player.dob)}</div>
                                </div>
