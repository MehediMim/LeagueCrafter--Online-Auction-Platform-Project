...
export default function AuctionAddTeamsForm() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post(`${API}/addAuction/addTeams`, form);
    ...
    return (<div className='w-full flex'>
        ...
        <div className='w-auto flex mt-20  justify-center items-start flex-col h-full p-10 text-white font-raleway'>
