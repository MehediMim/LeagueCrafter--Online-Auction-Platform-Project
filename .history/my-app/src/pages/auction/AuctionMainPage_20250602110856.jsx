...
function TeamModal({ team, auctionId, onClose }) {
    ...
    return (
        <div className="fixed inset-0 bg-white bg-opacity-60 flex justify-center items-center z-50">
            <div ref={visibleRef} className="bg-gray-900 text-black p-6 rounded-xl w-full max-w-2xl relative  max-h-[90vh] overflow-y-auto">
                {/* <div  className="bg-gray-900 text-white p-6 rounded-xl w-full max-w-2xl relative max-h-[90vh] overflow-y-auto"> */}
                <button
                    onClick={onClose}
                    className="absolute w-10 h-10 flex justify-center items-center top-2 right-2 text-black hover:bg-white hover:text-white text-2xl"
                >
                    &times;
                </button>
                ...
                <button
                    ...
                    className="absolute w-10 h-10 flex justify-center items-center top-2 right-20 text-black hover:bg-white hover:text-white text-2xl"
                >
                    📄
                </button>
            ...
            <div className="hidden">
                <div ref={printRef} className="p-6 w-[600px] text-white text-base">
                    <h2 className="text-2xl font-bold mb-4">{team.name}</h2>
                    <p><strong>Remaining Budget:</strong> ${team.remaining}</p>
