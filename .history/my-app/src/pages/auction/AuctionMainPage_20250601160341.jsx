...
export default function AuctionMainPage() {
        ...
        const fetchCurrentPlayer = async () => {
            try {
                ...
                if (res.data && res.data._id) {
                    // 🛠️ Avoid overwriting with incomplete data
                    if (!res.data.category && currentPlayer?.category) {
                        res.data.category = currentPlayer.category;
                    }
    ...
    }, [auctionId, currentPlayer?.category]);
