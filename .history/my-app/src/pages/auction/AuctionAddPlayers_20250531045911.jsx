                    ...
                    {players.map(player => (
                        ...
                        >
                            <div>
                                ...
                                <div className=' justify-start bg-zinc-800 p-3 relative -top-60 rounded-br-full font-bebas text-3xl items-start flex'>{player.name}</div>
                                <div className=' justify-start bg-zinc-800 p-3 relative -top-60 rounded-br-full font-bebas text-3xl items-start flex'>{calculateAge(player.dob)}</div>
