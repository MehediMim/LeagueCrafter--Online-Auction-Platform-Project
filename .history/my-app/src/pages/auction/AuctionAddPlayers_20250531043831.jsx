            ...
            <div className='w-full font-kanit'>
                ...
                <div className="grid grid-cols-4 gap-6">
                    {players.map(player => (
                        ...
                        >
                            <div>
                                <h2 className='font-bebas absolute bg-zinc-800 rounded-br-full pr-5 w-auto text-3xl text-center  justify-start items-start flex'>{player.name}</h2>
                                <div className='w-full h-40 bg-slate-400 rounded-md mt-2 mb-4'></div>
                                <div className='font-raleway relative -top-10 bg-zinc-800 w-20 right-30  text-md text-center'>
