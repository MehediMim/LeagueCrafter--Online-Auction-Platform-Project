                    ...
                    {players.map(player => (
                        ...
                        >
                            <div>
                                ...
                                <div className=' justify-start bg-zinc-700 px-3 relative -top-64 rounded-br-full font-bebas text-3xl items-start flex'>{player.name}</div>



                                <div className='text-center mb-2 relative -top-10'>
