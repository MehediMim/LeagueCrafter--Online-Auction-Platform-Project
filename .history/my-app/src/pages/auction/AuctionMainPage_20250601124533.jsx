                    ...
                    {currentPlayer ? (
                        <>
                            ...
                            <div className="mt-6 bg-gray-900 p-4 rounded text-white w-full max-w-md mx-auto">
                                ...
                                <BidList auctionId={auctionId} playerId={currentPlayer._id} />
                            </div>
                        </>
                    ) : (
...
// ✅ Inner BidList Component
function BidList({ auctionId, playerId }) {
    ...
    return (
        <ul className="space-y-2">
            {bids.map((bid, index) => (
                <li
                    key={index}
                    className="bg-gray-800 p-2 rounded shadow flex justify-between items-center"
                >
                    <div>
