                ...
                <div className="mt-6 p-5">
                    ...
                    {currentPlayer ? (
                        <div className="flex bg-black justify-evenly">
                            ...
                            <div className=" bg-white text-white w-full max-w-md mx-auto  border rounded-xl border-gray-600 bg-gray-800">
...
function BudgetList({ auctionId }) {
    ...
    return (
        <div className="ml-4 w-64 bg-gray-900 p-4 rounded-xl border border-gray-700">
