                    ...
                    {players.map((player) => (
                        ...
                        >
                            ...
                            <div className=' z-10  h-auto  bg-gray-900 bg-opacity-70  rounded-b-xl rounded-xl overflow-hidden'>
                                ...
                                <div>
                                    <p className='font-bebas relative h-auto text-3xl flex p-2 bg-gray-900 justify-center bg-opacity-50 items-center'>{calculateAge(player.dob)}<div className='text-lg ml-1'> years old</div></p>
                                </div>
                                <div className='w-full  flex h-auto justify-start items-center   px-2 py-2 bg-gray-700'><div className='text-xl font-raleway w-full flex justify-center items-center'>{player.role}</div></div>
                                {/* <p className='text-sm'>{player.category?.name || 'Uncategorized'}</p> */}
                                <div className='bg-gray-900 w-full px-2 pb-2 flex justify-center items-center'>
                                    <button
                                        onClick={() => handleDelete(player._id)}
                                        className="hidden group-hover:block  p-2 bg-red-600 text-white text-sm px-4  rounded hover:bg-red-700 transition"
                                    >
                                        Delete
                                    </button>
                                </div>
