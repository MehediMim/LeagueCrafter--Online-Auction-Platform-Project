                    ...
                    {players.map(player => (
                        ...
                        >
                            <div>
                                ...
                                <div className='w-full h-56 bg-slate-400 rounded-md mt-2 mb-4'></div>
                                <div className=' justify-start bg-zinc-800 relative -top-64 rounded-br-full font-bebas text-4xl items-start flex'>{player.name}</div>



                                <div className='text-center mb-2 relative -top-16 w-full flex right-10  justify-evenly '>
                                    <span className='text-sm font-semibold bg-slate-800 px-3  py-1 rounded-full border border-black'>
                                        {player.role}
                                    </span>

                                </div>
                                <div className='text-center mb-2 relative -top-28 -right-16 w-full flex  justify-evenly '>

                                    <span className=' font-semibold bg-slate-800 px-3 py-1 rounded-full font-raleway text-3xl border border-black'>
                                        {calculateAge(player.dob)}
                                    </span>
                                </div>


                                <div className='font-raleway text-md relative top-0 text-center mt-1'>
