                    ...
                    {players.map((player) => (
                        ...
                        >
                            ...
                            <div className=' z-10  h-auto  bg-gray-900 bg-opacity-70  rounded-b-xl rounded-xl overflow-hidden'>
                                ...
                                <div>
                                    <p className='font-bebas relative h-auto text-3xl flex px-2 bg-gray-900 bg-opacity-50 items-center'>{calculateAge(player.dob)}<div className='text-lg ml-1'> years</div></p>
                                </div>
