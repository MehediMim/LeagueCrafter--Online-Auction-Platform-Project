            ...
            <div className='w-4/6 '>
                <div className="   font-kanit ">
                    ...
                    <div className="space-y-4 ">
                        {teams.map(team => (
                            <div key={team._id} className="overflow-hidden bg-white p-4 rounded-xl flex justify-between items-center text-black"
                                // onClick={() => handleAuctionclick(team._id)}
                                style={{ backgroundColor: team.color_code || "#27272a" }}
                            >
                                <div className="w-40 rounded-full absolute  mr-4">
                                    <img
