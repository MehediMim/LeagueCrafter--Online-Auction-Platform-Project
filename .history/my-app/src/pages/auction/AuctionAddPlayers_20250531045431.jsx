            ...
            <div className='w-full font-kanit'>
                ...
                <div className="grid grid-cols-4 gap-6 ">
                    {players.map(player => (
                        <div
                            key={player._id}
                            className="w-56 h-96 p-3 absolute rounded bg-zinc-800 border border-gray-700 text-white shadow-lg flex flex-col justify-between"
                        >
                            <div>
                                <div className=''>
                                    <div className=' justify-start bg-zinc-800 p-3  items-start flex'>{player.name}</div>
