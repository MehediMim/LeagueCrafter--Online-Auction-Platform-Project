                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {players.map((player) => (
                        ...
                        >
                            ...
                            <div className='z-10 m-2 h-1/2  bg-gray-900 bg-opacity-70 p-2 rounded-b-xl rounded-xl'>
                                ...
                                <div className='w-full bg-slate-800 flex justify-center items-center rounded-lg'><p className='text-sm font-jaro'>{player.role}</p></div>
