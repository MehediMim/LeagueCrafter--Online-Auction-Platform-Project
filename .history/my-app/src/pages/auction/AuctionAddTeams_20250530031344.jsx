...
export default function AuctionAddTeams() {
    ...
    useEffect(() => {
        const fetchFiltered = async () => {
            try {
                const res = await axios.get(`${API}/addauction/getTeam`, {
                    params: {
                ...
                console.error("❌ Error fetching filtered teams:", error); // Fixed: 'err' -> 'error'
            }
        }
    ...
    return (
        <div className='flex justify-center w-screen'>
            <div className='w-4/6 '>
                <div className="bg-white  mt-20 font-kanit ">
