            ...
            <div className='w-4/6 '>
                <div className="   font-kanit ">
                    ...
                    <div className="space-y-4 ">
                        {teams.map(team => (
                            <div key={team._id} className="overflow-hidden   p-4 rounded-xl flex justify-between items-center text-black"
                                // onClick={() => handleAuctionclick(team._id)}
                                style={{ backgroundColor: team.color_code || "#27272a" }}
                            >
                                <div className="w-40 h-32 overflow-hidden rounded-full absolute flex-shrink-0 mr-4">
                                    <img
