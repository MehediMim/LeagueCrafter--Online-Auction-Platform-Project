                ...
                <div className="mt-6 p-5 ">
                    ...
                    {currentPlayer ? (
                        <div className="flex ">
                            ...
                            <div className=" text-white w-full max-w-md mx-auto p-5 border rounded-xl border-gray-600 bg-gray-800">
                                {/* <h3 className="text-lg font-semibold mb-2">📝 Bids for {currentPlayer.name}</h3> */}
                                <p className="text-white font-raleway font-bold mb-2 text-center text-2xl w-full bg-black">
