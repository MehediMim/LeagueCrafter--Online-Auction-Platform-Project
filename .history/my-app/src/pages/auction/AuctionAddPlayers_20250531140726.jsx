                    ...
                    {players.map((player) => (
                        ...
                        >
                            ...
                            <div className=' z-10  h-auto  bg-gray-900 bg-opacity-70  rounded-b-xl rounded-xl'>
                                ...
                                <div>
                                    <p className='font-bebas text-3xl flex px-2 bg-gray-900 truncate rounded-t-xl bg-opacity-50 items-center'>{calculateAge(player.dob)}<div className='text-lg ml-1'> years</div></p>
                                </div>
                                <div className='w-full flex justify-start items-center rounded-t-xl px-2 pt-2 bg-gray-900'><p className='text-xl font-raleway'>{player.role}</p></div>
