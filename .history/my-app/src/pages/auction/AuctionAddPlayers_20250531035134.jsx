            ...
            <div className='w-4/6 font-kanit'>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {players.map(player => (
                        <div
                            key={player._id}
                            className="p-4 rounded w-full h-80 flex flex-col justify-between items-start bg-zinc-800 text-white shadow-md"
                        >
                            ...
                            <button
                                className="hover:bg-white px-3 py-1 rounded text-white hover:text-black font-rubik self-end"
                                onClick={(e) => {
                                    e.stopPropagation();
