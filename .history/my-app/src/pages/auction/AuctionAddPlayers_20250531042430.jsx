...
export default function AuctionAddPlayers() {
    ...
    return (
        <div className='ml-20 flex flex-col justify-center items-start h-full w-full'>
            <div className='w-11/12 font-kanit'>
                <h1 className="text-4xl font-rubik font-bold text-white mb-10 mt-40">All Players</h1>

                <div className="grid grid-cols-4 gap-6">
                    {players.map(player => (
                        <div
                            key={player._id}
                            className="w-56 h-96 p-3 rounded bg-zinc-800 border border-gray-700 text-white shadow-lg flex flex-col"
                        >
                            <div>
                                {/* Player Name */}
