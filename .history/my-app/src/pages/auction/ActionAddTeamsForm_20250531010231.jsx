...
export default function AddTeamForm() {
    ...
    const getAuctionDetails = async () => {
        ...
        try {
            ...
            // Construct tier summary directly from fetched data
            const tierSummaryInit = {};
            data.tiers.forEach(tier => {
                tierSummaryInit[tier] = 0;
            });

            // Now safely update form using the fetched data
            setForm(prev => ({
                ...prev,
                budget_remaining: data.budget_per_team,
                tier_summary: tierSummaryInit
            }));
