...
export default function AuctionMainPage() {
    ...
    // Pick random player & save to backend
    ...
    // Get current player
    // Fetch current player every 3 seconds
    useEffect(() => {
        let intervalId;
        ...
        if (auctionId) {
            fetchCurrentPlayer(); // initial load
            intervalId = setInterval(fetchCurrentPlayer, 3000); // poll every 3 seconds
        }
                                ...
                                <div className="z-10 h-auto bg-gray-900 bg-opacity-70 rounded-b-xl rounded-xl overflow-hidden">
                                    ...
                                    <div>
                                        <p className="font-bebas text-3xl flex p-2 bg-gray-900 justify-center bg-opacity-50 items-center">
                                            ...
                                            <div className="text-lg ml-1 font-raleway"> years old</div>
                                        </p>
                                    </div>
