...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center h-screen w-screen bg-zinc-900">
      <div className="p-10 rounded-xl w-96 font-kanit text-center flex flex-col items-start bg-zinc-800 shadow-xl">
        <h1 className="text-4xl font-jaro text-white mb-6">Sign In</h1>

        <button
          onClick={() => loginWithRedirect()}
          className="flex items-center gap-4 justify-center text-white font-jaro px-6 py-3 rounded shadow hover:bg-white hover:text-black w-full font-semibold mb-2 bg-blue-600"
        >
          Sign in with Google
        </button>
      </div>
