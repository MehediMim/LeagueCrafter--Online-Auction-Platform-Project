                ...
                <form onSubmit={handleSubmit} className='flex gap-6'>
                    ...
                    <div className='w-1/2 space-y-5'>
                        ...
                        <div className='bg-zinc-800 rounded-xl p-5'>
                            ...
                            <div className='flex mt-4 gap-2 bg-white h-full items-start'>
                                <div className='w-2/3 flex bg-red-700 h-full items-center justify-center'>
                                <input
                                    type="text"
                                    placeholder="New tier name"
                                    value={newTier}
                                    onChange={(e) => setNewTier(e.target.value)}
                                    className='w-full h-10 bg-zinc-700 flex items-center  rounded-xl px-3 text-white'
                                />
                                </div>
                                <div>
                                <button
                                    ...
                                    className='text-white  font-semibold px-4 rounded hover:bg-yellow-400'
                                >
                                    + Add Tier
                                </button>
                                </div>
