            ...
            <div className='w-4/6 '>
                <div className="  mt-20 font-kanit ">
                        ...
                        {mockAuctions.map(auction => (
                            <div key={auction.id} className="bg-zinc-800 p-4 rounded flex justify-between items-center">
                                ...
                                <div className="space-x-2">
                                    <button className=" hover:bg-blue-400 px-3 py-1 rounded text-blue-400 hover:text-white font-jaro">Modify</button>
                                    <button className=" hover:bg-red-400 px-3 py-1 rounded text-red-400 hover:text-white font-jaro">Delete</button>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="flex justify-between items-center mt-4">
                        ...
                        <button className=" hover:bg-green-400 text-green-400 hover:text-white px-5 py-2 rounded text-white font-bold shadow">
                            + Create New Auction
                        </button>
                    </div>
                </div>
