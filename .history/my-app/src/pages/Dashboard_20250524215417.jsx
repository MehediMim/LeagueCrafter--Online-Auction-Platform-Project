                        ...
                        {mockAuctions.map(auction => (
                            <div key={auction.id} className="bg-zinc-800 p-4 rounded flex justify-between items-center">
                                ...
                                <div className="space-x-2">
                                    <button className=" hover:bg-blue-700 px-3 py-1 rounded font-raleway">Modify</button>
                                    <button className=" hover:bg-red-700 px-3 py-1 rounded text-red-600">Delete</button>
                                </div>
                            </div>
                        ))}
                    </div>
