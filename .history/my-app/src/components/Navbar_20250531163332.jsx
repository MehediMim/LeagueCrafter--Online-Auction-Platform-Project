...
export default function Navbar(params) {
  ...
  return (
    <div className="h-16 bg-white w-screen absolute top-3 z-50 flex justify-center">
      <div className="w-2/3 flex justify-center">
        <div className="bg-zinc-800 bg-opacity-20 shadow-md p-4 rounded-xl w-full flex items-center">
