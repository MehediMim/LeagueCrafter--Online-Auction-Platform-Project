      ...
      <div className="bg-zinc-900 shadow-md p-4 rounded-xl w-2/3 flex items-center">
        {/* <div className="w-auto h-auto rounded-xl m-4 flex p-4"> */}
          ...
          <div className="w-full flex justify-evenly   items-center">
            <Link className="text-amber-800 hover:text-white"><h1 className="text-3xl font-jaro">home</h1></Link>
            <Link className="text-amber-800 hover:text-white"><h1 className="text-3xl font-jaro">registrations</h1></Link>
            <Link className="text-amber-800 hover:text-white"><h1 className="text-3xl  font-jaro">login</h1></Link>
          </div>
        {/* </div> */}
      </div>
    </div>
