      ...
      <div className=" flex flex-col justify-end ">
        <div className=" p-4 rounded-xl w-full flex flex-col items-end">
          ...
          <div className=" flex justify-evenly   items-center">
            ...
            {!isAuthenticated && <Link to="/login" className="text-amber-600 hover:text-white mb-4"><h1 className="text-2xl  font-rubik">login</h1></Link>}
            {isAuthenticated && <Link to="/dashboard" className="text-amber-600 hover:text-white mb-4"><h1 className="text-2xl  font-rubik">dashboard</h1></Link>}
