    ...
    <div className="  absolute right-3 top-3  z-50 flex justify-end">
      <div className=" flex flex-col justify-end ">
        <div className=" p-4 rounded-xl w-full flex flex-col items-end">
          ...
          <div className="w-56 rounded-lg py-2 bg-slate-900 mb-4 flex justify-center">
            <Link to="/"><button className="font-jaro text-4xl text-amber-400 hover:text-white">DRAFT</button></Link>
          </div>
          <div className=" flex justify-evenly   items-center">
            ...
            {!isAuthenticated && <Link to="/login" className="text-amber-600 hover:text-white mb-4 w-56 rounded-lg py-2 "><button className="text-2xl w-56 font-rubik">login</button></Link>}
            {isAuthenticated && <Link to="/dashboard" className="text-amber-600 hover:text-white mb-4 w-56 rounded-lg py-2 "><button className="text-2xl w-56 font-rubik">dashboard</button></Link>}
