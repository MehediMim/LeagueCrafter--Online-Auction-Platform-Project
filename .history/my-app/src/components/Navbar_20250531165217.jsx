      ...
      <div className=" flex flex-col justify-end ">
        <div className=" p-4 rounded-xl w-full flex flex-col items-end">
          ...
          <div className="w-56  flex justify-center">
            <Link to="/"><button className=" w-56 font-railway font-bold text-amber-400 hover:text-white">LeagueCrafter</button></Link>
          </div>
          <div className=" flex justify-evenly   items-center">
            ...
            {!isAuthenticated && <Link to="/login" className="text-white font-rubik font-bold hover:text-white  w-56 rounded-lg py-2 "><button className="text-2xl w-56 font-rubik">login</button></Link>}
            {isAuthenticated && <Link to="/dashboard" className="text-white font-rubik font-bold hover:text-white  w-56 rounded-lg py-2 "><button className="text-2xl w-56 font-rubik">dashboard</button></Link>}
