...
export default function Sidebar() {
    ...
    return (
        <div className='w-full'>
            <div className=' ml-10 mb-10 font-rubik  text-2xl text-white'>
                <div className='font-bold'>{auction ? auction.name : "Loading..."}</div>
                <div className=''>{auction ? auction.status : "Loading..."}</div>
            </div>   
