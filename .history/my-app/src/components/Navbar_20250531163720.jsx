...
export default function Navbar(params) {
  ...
  return (
    <div className=" w-screen absolute top-3 z-50 flex justify-end">
      <div className=" flex flex-col justify-center">
        <div className="bg-zinc-800 bg-opacity-20 shadow-md p-4 rounded-xl w-full flex flex-col items-end">
        ...
        {isAuthenticated && <div className=" h-16 w-16  ml-3 group cursor-pointer  relative">
          ...
          <div className="absolute top-10 right-36 -translate-x-1/2  bg-zinc-800 text-white rounded-xl p-4 shadow-lg hidden group-hover:block z-50">
