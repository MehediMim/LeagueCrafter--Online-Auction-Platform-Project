    ...
    <div className="h-16 w-screen absolute top-3 z-50 flex justify-center">
      <div className="w-2/3 flex justify-center">
        ...
        {isAuthenticated && <div className=" h-16 w-16  ml-3 group cursor-pointer relative">
          ...
          <div className="absolute top-10 left-36 -translate-x-1/2 w-52 bg-zinc-800 text-white rounded-xl p-4 shadow-lg hidden group-hover:block z-50">
            <p className="text-lg font-bold font-kanit text-center">{user.name}</p>
            <p className="text-lg  font-kanit text-center">{user.email}</p>
            <button
