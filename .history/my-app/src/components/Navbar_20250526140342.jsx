  ...
  return (
    <div className="h-16 w-screen absolute top-3 z-50 flex justify-center">
      <div className="w-2/3 flex justify-center">
        <div className="bg-zinc-800 bg-opacity-50 shadow-md p-4 rounded-xl w-full flex items-center">
          ...
          <div className="w-full flex justify-evenly   items-center">
            ...
            {!isAuthenticated && <Link to="/login" className="text-amber-600 hover:text-white"><h1 className="text-32xl  font-rubik">login</h1></Link>}
