...
export default function Navbar(params) {
  ...
  return (
    <div className="h-16 w-screen absolute top-3 z-50 flex justify-center">
      <div className="bg-zinc-800 shadow-md p-4 rounded-xl w-2/3 flex items-center">
        {/* <div className="w-auto h-auto rounded-xl m-4 flex p-4"> */}
          ...
          <div className="w-full flex justify-evenly   items-center">
            ...
            {isAuthenticated && <Link to="/login" className="text-amber-600 hover:text-white"><h1 className="text-3xl  font-jaro">dashboard</h1></Link>}
