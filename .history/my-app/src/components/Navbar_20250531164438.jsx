      ...
      <div className=" flex flex-col justify-end ">
        <div className=" p-4 rounded-xl w-full flex flex-col items-end">
          ...
          <div className=" flex justify-evenly   items-center">
            ...
            {!isAuthenticated && <Link to="/login" className="text-amber-600 hover:text-white mb-4 w-56 rounded-lg py-2 "><button className="text-2xl  font-rubik">login</button></Link>}
            {isAuthenticated && <Link to="/dashboard" className="text-amber-600 hover:text-white mb-4 w-56 rounded-lg py-2 "><button className="text-2xl  font-rubik">dashboard</button></Link>}
