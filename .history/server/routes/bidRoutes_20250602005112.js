...
router.get('/maxSafeBid', async (req, res) => {
    ...
    try {
        ...
        console.log("✅ Team found:", team.name, "| Budget Remaining:", team.budget_remaining);
        ...
        reservedMoney.push(...Array(optionalSlots).fill(cheapestPrice));

        totalReserved = reservedMoney.reduce((a, b) => a + b, 0);
